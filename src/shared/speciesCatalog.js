...
export const SPECIES = Object.freeze([
  ...
  s("whale_shark", "Whale Shark", "Rhincodon typus", "shark", "sharkgrey",
    [["juvenile", 300, 4000], ["adult", 1200, 34000]], ["coral_triangle"], ["epipelagic"], 2),
  s("reef_manta", "Reef Manta Ray", "Mobula alfredi", "ray", "rayshadow",
    [["juvenile", 150, 1500], ["adult", 400, 20000]], ["coral_triangle"], ["epipelagic"], 4),
  s("giant_manta", "Giant Oceanic Manta", "Mobula birostris", "ray", "rayshadow",
    [["juvenile", 200, 3000], ["adult", 700, 30000]], ["coral_triangle"], ["epipelagic"], 3),
  ...
  s("humpback_whale", "Humpback Whale", "Megaptera novaeangliae", "whale", "whaleblue",
    [["calf", 450, 8000], ["adult", 1400, 45000]], ["north_atlantic", "antarctic_convergence"], ["epipelagic"], 2),
  s("fin_whale", "Fin Whale", "Balaenoptera physalus", "whale", "whaleblue",
    [["calf", 650, 12000], ["adult", 2000, 60000]], ["north_atlantic"], ["epipelagic"], 2),
  s("minke_whale", "Minke Whale", "Balaenoptera acutorostrata", "whale", "whaleblue",
    [["calf", 270, 3000], ["adult", 850, 22000]], ["north_atlantic", "antarctic_convergence"], ["epipelagic"], 3),
  ...
  s("basking_shark", "Basking Shark", "Cetorhinus maximus", "shark", "sharkgrey",
    [["juvenile", 300, 4000], ["adult", 900, 30000]], ["north_atlantic", "norwegian_sea"], ["epipelagic"], 2),
