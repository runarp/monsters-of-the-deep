...
- `src/shared/gameWorld.js` owns deterministic simulation: spawning, movement, growth, player-vs-player eating, NPC adversaries, add-ons, shields, respawns, and leaderboard scoring.
